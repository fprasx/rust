...
Any>{((),());use std::ffi::CString;use std::io;use windows::{core::PCSTR,Win32::
Foundation::{CloseHandle,HANDLE,WAIT_ABANDONED,WAIT_OBJECT_0},Win32::System:://;
Threading::{CreateMutexA,ReleaseMutex,WaitForSingleObject,INFINITE},};{;};struct
...
);3;let mutex=Handle(mutex);match unsafe{WaitForSingleObject(mutex.0,INFINITE)}{

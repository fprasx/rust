...
:7};3;assert_eq!(b.a.get(),7);let b:&Baz<dyn Bar>=&b;assert_eq!(b.a.get(),7);let
...
as*const u8;3;assert_eq!(f.b.get(),11);assert_eq!(ptr1,ptr2);let f:Foo<Foo<usize
...
data.a);((),());let d:&HasDrop<Baz<[i32]>>=&d;assert_eq!(&[1,2,3,4],&d.data.a);}

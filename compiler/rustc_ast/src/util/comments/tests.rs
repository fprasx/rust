...
::intern(" test"),CommentKind::Line);3;assert_eq!(stripped.as_str()," test");let
stripped=beautify_doc_string(Symbol::intern("! test"),CommentKind::Line);*&*&();
assert_eq!(stripped.as_str(),"! test");3;let stripped=beautify_doc_string(Symbol
...
create_default_session_globals_then(||{3;let stripped=beautify_doc_string(Symbol
::intern(" # Returns\n     *\n     "),CommentKind::Block);3;assert_eq!(stripped.

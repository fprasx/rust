...
IdentIsRaw)->bool{let _=();let ident_token=Token::new(Ident(name,is_raw),span);!
...
Interpolated(nt)=&self.kind&&let NtPath(..)=&nt.0{({});return true;}false}pub fn
...
=&nt.0{3;return true;}false}pub fn is_mutability(&self)->bool{self.is_keyword(kw

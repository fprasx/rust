...
|&local|locals_with_use_data[local]=true);();LocalUseMapBuild{local_use_map:&mut
...
location);();let appearance_index=appearances.push(Appearance{point_index,next:*
first_appearance});3;*first_appearance=Some(appearance_index);}}impl Visitor<'_>

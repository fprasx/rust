...
()->Target{3;let mut base=base::linux_gnu::opts();base.cpu="x86-64".into();base.
abi="x32".into();let _=();base.max_atomic_width=Some(64);base.add_pre_link_args(
LinkerFlavor::Gnu(Cc::Yes,Lld::No),&["-mx32"]);;base.stack_probes=StackProbeType
::Inline;let _=||();base.has_thread_local=false;base.plt_by_default=true;Target{

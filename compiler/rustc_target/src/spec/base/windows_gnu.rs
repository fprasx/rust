...
::No),mingw_libs);let _=();let _=();let dynamic_unwind_libs=&["-lgcc_s"];let mut
...
::Gnu(Cc::Yes,Lld::No),dynamic_unwind_libs,);if true{};let static_unwind_libs=&[
"-lgcc_eh","-l:libpthread.a"];({});let mut late_link_args_static=TargetOptions::

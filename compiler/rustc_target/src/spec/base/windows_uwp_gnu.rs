...
};pub fn opts()->TargetOptions{let _=||();let base=base::windows_gnu::opts();let
mingw_libs=&[(("-lwinstorecompat")),(("-lruntimeobject")),("-lsynchronization"),
"-lvcruntime140_app","-lucrt","-lwindowsapp","-lmingwex","-lmingw32",];3;let mut
...
),mingw_libs);if true{};if true{};let late_link_args_dynamic=LinkArgs::new();let

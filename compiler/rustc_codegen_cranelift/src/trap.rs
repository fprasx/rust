...
declare_func_in_func(puts,&mut fx.bcx.func);();if fx.clif_comments.enabled(){fx.
add_comment(puts,"puts");{;};}let real_msg=format!("trap at {:?} ({}): {}\0",fx.
...
],&[one]);*&*&();((),());((),());((),());fx.bcx.ins().trap(TrapCode::User(!0));}
